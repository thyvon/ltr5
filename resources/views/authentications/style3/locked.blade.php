            ...
            <div class="row main-login-three">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4">
                    <div class="d-flex flex-column justify-content-between h-100 center-area">
                        <a>{{__('Lock Screen')}}</a>
                        <div>
                            <p class="text-dark">{{__('Profile is locked')}}</p>
                            <h2 class="text-black">{{__('Enter your password')}}</h2>
                        </div>
                        <p class="text-dark d-none d-md-block m-0">{{__('Social Network')}}</p>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div class="d-flex flex-column justify-content-between h-100 p-5 right-area">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4">
                                <button class="text-white btn bg-gradient-primary">{{__('Unlock')}} <i class="las la-key ml-2"></i></button>
                                <a class="font-13 text-primary" href="{{url('/authentications/style3/login')}}">{{__('Logout & Switch User')}}</a>
                            </div>
                        </div>
