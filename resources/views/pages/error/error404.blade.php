                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>{{__('Error 404')}}</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
            ...
            <div class="col-md-12">
                <div class="row align-items-center">
                    <div class="col-md-7">
                        ...
                        <p class="font-25 mb-4">{{__('Sorry, We can\'t seem to find the page you\'re looking for.')}}</p>
                        <a class="btn bg-gradient-primary text-white">{{__('Back to Home')}}</a>
                    </div>
